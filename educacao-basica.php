<?php $page_title = "Educação Básica - Pincel Atômico"; ?>
...
<body>
    ...
    <main>
        <!-- Hero Section -->
        <section class="hero-recursos" style="background: linear-gradient(135deg, rgba(242, 56, 39, 0.7) 0%, rgba(239, 68, 68, 0.7) 100%), url('images/segmentos/basica.jpg') center/cover; color: white; padding: 70px 0 40px; position: relative; overflow: hidden;">
            <div class="container">
                <div style="display: flex; align-items: center; gap: 60px; margin-top: 20px;">
                    <div style="flex: 1;">
                        <h1 style="font-size: 3rem; margin-bottom: 20px; line-height: 1.2;">Educação Infantil, Fundamental e Médio</h1>
                        <h2 style="font-size: 1.5rem; margin-bottom: 30px; font-weight: 400; opacity: 0.9;">Simplifique a gestão da sua escola com uma solução completa</h2>
                        <p style="font-size: 1.2rem; margin-bottom: 40px; line-height: 1.6; opacity: 0.9;">Tenha o <strong>controle total</strong> da sua instituição de educação infantil, fundamental ou médio em uma única plataforma. Com painéis intuitivos e fáceis de usar, você integra a gestão pedagógica e financeira.</p>
                        <a href="demonstracao" onclick="if(typeof fbq !== 'undefined') fbq('track', 'Lead', {content_name: 'Demonstracao'});" class="cta-button2" style="background: white; color: #F23827; padding: 15px 40px; font-size: 1.1rem; border-radius: 30px; text-decoration: none; font-weight: 600; display: inline-block; transition: all 0.3s ease;" onmouseover="this.style.transform='translateY(-3px)'; this.style.boxShadow='0 10px 25px rgba(0,0,0,0.2)'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='none'">Solicite uma Demonstração Gratuita</a>
                    </div>
                    <div style="flex-shrink: 0;">
                        <img src="images/notebook/note-sem-sombra.png" alt="Nota 5 MEC" style="width: 520px; height: 520px; object-fit: contain; filter: drop-shadow(0 20px 40px rgba(0,0,0,0.3));">
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="segmentos-cards-vertical" style="display: flex; flex-direction: column; gap: 40px;">
                    <div class="segmento-card" style="background: white; border-radius: 16px; padding: 40px; box-shadow: 0 10px 30px rgba(30, 58, 138, 0.1); transition: transform 0.3s ease, box-shadow 0.3s ease;" onmouseover="this.style.transform='translateY(-5px)'; this.style.boxShadow='0 20px 40px rgba(30, 58, 138, 0.15)'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 10px 30px rgba(30, 58, 138, 0.1)'">
                        <div class="card-content" style="display: flex; align-items: center; gap: 40px;">
                            <div class="card-text" style="flex: 1; width: 50%;">
                                <h3 style="color: #1e3a8a; font-size: 1.8rem; margin-bottom: 15px;">Aplicativo Disponível Para Pais e Responsáveis</h3>
                                <h4 style="color: #F23827; font-size: 1.2rem; margin-bottom: 20px; font-weight: 600;">Acompanhamento próximo e transparente da vida escolar</h4>
                                <p style="color: #4b5563; line-height: 1.6; margin-bottom: 25px;">Aplicativo dedicado oferece acesso completo a boletins, frequências, avisos, comunicados, agenda escolar, mensagens e informações financeiras. <strong>Comunicação direta e eficiente</strong> centraliza todas as informações em um canal único, reduzindo ruídos e garantindo que pais estejam sempre atualizados. Professores registram diários de classe e documentos obrigatórios pelo celular, promovendo um ambiente escolar mais seguro, colaborativo e alinhado.</p>
                            </div>
                            <div class="card-image" style="flex: 1; width: 50%;">
                                <img src="images/segmentos/educacao basica/aplicativo.png" alt="Aplicativo Pais" style="width: 100%; height: 320px; object-fit: cover; border-radius: 12px; box-shadow: 0 8px 25px rgba(30, 58, 138, 0.15);">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="segmento-card" style="background: white; border-radius: 16px; padding: 40px; box-shadow: 0 10px 30px rgba(30, 58, 138, 0.1); transition: transform 0.3s ease, box-shadow 0.3s ease;" onmouseover="this.style.transform='translateY(-5px)'; this.style.boxShadow='0 20px 40px rgba(30, 58, 138, 0.15)'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 10px 30px rgba(30, 58, 138, 0.1)'">
                        <div class="card-content" style="display: flex; align-items: center; gap: 40px;">
                            <div class="card-image" style="flex: 1; width: 50%;">
                                <img src="images/segmentos/educacao basica/portal do aluno.png" alt="Portal Personalizado" style="width: 100%; height: 320px; object-fit: cover; border-radius: 12px; box-shadow: 0 8px 25px rgba(30, 58, 138, 0.15);">
                            </div>
                            <div class="card-text" style="flex: 1; width: 50%;">
                                <h3 style="color: #1e3a8a; font-size: 1.8rem; margin-bottom: 15px;">Portal Personalizado com sua Marca</h3>
                                <h4 style="color: #F23827; font-size: 1.2rem; margin-bottom: 20px; font-weight: 600;">Identidade visual única da sua instituição</h4>
                                <p style="color: #4b5563; line-height: 1.6; margin-bottom: 25px;">O Pincel Atômico valoriza a identidade da sua instituição. Todas as áreas de acesso, tanto para alunos quanto para professores, são totalmente personalizáveis com sua marca, cores e identidade visual. <strong>Experiência única e profissional</strong> reforça a presença e valores da instituição em cada detalhe do sistema. Além disso, você personaliza o que cada aluno pode fazer ou ver dentro do portal, garantindo controle total sobre permissões e acessos.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="segmento-card" style="background: white; border-radius: 16px; padding: 40px; box-shadow: 0 10px 30px rgba(30, 58, 138, 0.1); transition: transform 0.3s ease, box-shadow 0.3s ease;" onmouseover="this.style.transform='translateY(-5px)'; this.style.boxShadow='0 20px 40px rgba(30, 58, 138, 0.15)'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 10px 30px rgba(30, 58, 138, 0.1)'">
                        <div class="card-content" style="display: flex; align-items: center; gap: 40px;">
                            <div class="card-text" style="flex: 1; width: 50%;">
                                ...
                                <h4 style="color: #F23827; font-size: 1.2rem; margin-bottom: 20px; font-weight: 600;">Tudo integrado em uma única plataforma</h4>
                                <p style="color: #4b5563; line-height: 1.6; margin-bottom: 25px;">O Pincel Atômico integra todas as necessidades da sua escola: controle financeiro, acadêmico, matrículas, comunicação integrada e marketing. <strong>Reduza custos operacionais</strong> eliminando a dependência de vários sistemas distintos, minimizando gastos com licenças, treinamentos e suporte técnico. Painéis intuitivos e relatórios completos facilitam a tomada de decisões, otimizando o tempo da equipe e garantindo maior eficiência em cada etapa da gestão educacional.</p>
                            </div>
                            <div class="card-image" style="flex: 1; width: 50%;">
                                <img src="images/segmentos/educacao basica/acompanhamento.png" alt="Acompanhamento Completo" style="width: 100%; height: 320px; object-fit: cover; border-radius: 12px; box-shadow: 0 8px 25px rgba(30, 58, 138, 0.15);">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="todos-recursos">
            <div class="container">
                <h2>Recursos Completos para Educação Básica</h2>
        ...
        <section class="cta-demonstracao">
            <div class="container">
                <h2>Transforme a Gestão da sua Escola</h2>
                <p>Descubra como o Pincel Atômico pode simplificar e modernizar a gestão da sua instituição de educação básica.</p>
